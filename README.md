1. [Getting Started](#getting-started)
  1. [IIS Hosted](#iis-hosted)
  2. [Self-hosted](#self-hosted)
  3. [OWIN](#owin)
2. [Troubleshooting](#troubleshooting)
3. [Customizing the Generated Swagger Docs](#customizing-the-generated-swagger-docs)
  1. [Custom Routes](#custom-routes)
  2. [Additional Service Metadata](#additional-service-metadata)
    1. [RootUrl](#rooturl)
    2. [Schemes](#schemes)
    3. [SingleApiVersion](#singleapiversion)
  3. [Describing Multiple API Versions](#describing-multiple-api-versions)
  4. [Describing Security/Authorization Schemes](#describing-securityauthorization-schemes)
  5. [Customize the Operation Listing](#customize-the-operation-listing)
    1. [IgnoreObsoleteActions](#ignoreobsoleteactions)
    2. [GroupActionsBy](#groupactionsby)
    3. [OrderActionGroupsBy](#orderactiongroupsby)
  6. [Modifying Generated Schemas](#modifying-generated-schemas)
    1. [IgnoreObsoleteProperties](#ignoreobsoleteproperties)
    2. [MapType](#maptype)
    3. [SchemaFilter](#schemafilter)
    4. [UseFullTypeNamesInSchemaIds](#usefulltypenamesinschemaids)
    5. [DescribeAllEnumsAsStrings](#describeallenumsasstrings)
  7. [Modifying Generated Operations](#modifying-generated-operations)
    1. [OperationFilter](#operationfilter)
    2. [DocumentFilter](#documentfilter)
  8. [Wrapping the SwaggerGenerator with Additional Behavior](#wrapping-the-swaggergenerator-with-additional-behavior)
  9. [Including XML Comments](#including-xml-comments)
    1. [Response Codes](#response-codes)
  10. [Working Around Swagger 2.0 Constraints](#working-around-swagger-20-constraints)
4. [Customizing the swagger-ui](#customizing-the-swagger-ui)
  1. [Customizations via the configuration API](#customizations-via-the-configuration-api)
    1. [InjectStylesheet](#injectstylesheet)
    2. [InjectJavaScript](#injectjavascript)
    3. [BooleanValues](#booleanvalues)
    4. [SetValidatorUrl/DisableValidator](#setvalidatorurldisablevalidator)
    5. [DocExpansion](#docexpansion)
  2. [Provide your own "index" file](#provide-your-own-index-file)
  3. [Injecting Custom Content](#injecting-custom-content)
5. [Transitioning to Swashbuckle 5.0](#transitioning-to-swashbuckle-50)
6. [Troubleshooting and FAQ's](#troubleshooting-and-faqs)
