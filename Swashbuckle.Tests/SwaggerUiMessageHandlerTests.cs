...
namespace Swashbuckle.Tests
{
    ...
    {
        private SwaggerUiMessageHandler _messageHandler;
        ...
        public void FixtureSetup()
        {
            ...
            _messageHandler = new SwaggerUiMessageHandler((req) => "http://tempuri.org");
        }
        ...
        private string ExecuteRequest(string uri)
        {
            ...
            //request.Properties["MS_HttpRouteData"]

            var response = new HttpMessageInvoker(_messageHandler)
