...
namespace Swashbuckle.Tests.SwaggerUi20
{
    [TestFixture]
    public class SwaggerUi20Tests : HttpMessageHandlerTestFixture<SwaggerUi20Handler>
    {
        private SwaggerUi20Config _swaggerUiConfig;

        public SwaggerUi20Tests()
        ...
        [Test]
        public void It_should_provide_the_embedded_swagger_ui()
        {
        ...
        [Test]
        public void It_should_support_config_to_inject_custom_stylesheets()
        {
        ...
        [Test]
        public void It_should_support_config_for_swagger_ui_settings()
        {
            _swaggerUiConfig
                .SupportHeaderParams()
        ...
        [Test]
        public void It_should_support_config_to_inject_custom_javascripts()
        {
            var assembly = typeof(SwaggerConfig).Assembly;
        ...
        [Test]
        public void It_should_support_config_to_serve_custom_web_assets()
        {
            var assembly = typeof(SwaggerConfig).Assembly;
        ...
        [Test]
        public void It_should_error_on_web_assets_not_found_and_return_status_not_found()
        {
