...
namespace Swashbuckle.Models
{
    ...
    {
        public static SwaggerSpec GetInstance(IApiExplorer apiExplorer, HttpRequestMessage request)
        {
            var basePath = SwaggerSpecConfig.Instance.BasePathResolver(request);
